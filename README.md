...
Code der habify30-App auf Zoho Catalyst: Functions unter `functions/`, Oberfläche unter
`shell/`, Projektkonfiguration in `catalyst.json`. Produkt-Entscheidungen und das Warum der
Architektur leben im Repo `habify` (`decisions/`), nicht hier.
